...
create
external table dwd_dim_sku_info (
...
insert
overwrite table dwd_dim_sku_info partition(dt)
select sku.id,
       sku.spu_id,
       sku.price,
       sku.sku_name,
...
create
external table dwd_dim_coupon_info(
...
insert
overwrite table dwd_dim_coupon_info partition(dt='2025-03-23')
select id,
       coupon_name,
       coupon_type,
       condition_amount,
...
create
external table dwd_dim_activity_info(
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_dim_activity_info partition(dt='2025-03-23')
select id,
       activity_name,
       activity_type,
       start_time,
...
create
external table dwd_dim_base_province (
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_dim_base_province
select bp.id,
       bp.name,
       bp.area_code,
       bp.iso_code,
...
create
external table dwd_fact_payment_info (
    `id` string COMMENT 'id',
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_fact_payment_info partition(dt='2025-03-23')
select pi.id,
       pi.out_trade_no,
       pi.order_id,
       pi.user_id,
...
create
external table dwd_fact_order_refund_info(
    `id` string COMMENT '编号',
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_fact_order_refund_info partition(dt='2025-03-23')
select id,
       user_id,
       order_id,
       sku_id,
...
create
external table dwd_fact_comment_info(
    `id` string COMMENT '编号',
    `user_id` string COMMENT '用户ID',
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_fact_comment_info partition(dt='2025-03-23')
select id,
       user_id,
       sku_id,
       spu_id,
...
create
external table dwd_fact_order_detail (
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_fact_order_detail partition(dt='2025-03-23')
select id,
       order_id,
       user_id,
       sku_id,
...
from (
         select od.id,
                ...
                round(od.order_price * od.sku_num / oi.original_total_amount * oi.final_total_amount,
                      2)                              final_amount_d,
                round(od.order_price * od.sku_num / oi.original_total_amount * oi.feight_fee,
                      2)                              feight_fee_d,
                row_number()                          over(partition by od.order_id order by od.id desc) rn, round(
                ...
                sum(round(od.order_price * od.sku_num / oi.original_total_amount * oi.final_total_amount,
                          2))                         over(partition by od.order_id) sum_div_final_amount, sum(round(
                             od.order_price * od.sku_num / oi.original_total_amount * oi.feight_fee,
                             2)) over(partition by od.order_id) sum_div_feight_fee, sum(round(
                             od.order_price * od.sku_num / oi.original_total_amount * oi.benefit_reduce_amount, 2)) over(partition by od.order_id) sum_div_benefit_reduce_amount
         from (
                  select *
...
create
external table dwd_fact_cart_info(
    `id` string COMMENT '编号',
    `user_id` string  COMMENT '用户id',
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_fact_cart_info partition(dt='2025-03-23')
select id,
       user_id,
       sku_id,
       cart_price,
...
create
external table dwd_fact_favor_info(
    `id` string COMMENT '编号',
    `user_id` string  COMMENT '用户id',
    `sku_id` string  COMMENT 'skuid',
    `spu_id` string  COMMENT 'spuid',
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_fact_favor_info partition(dt='2025-03-23')
select id,
       user_id,
       sku_id,
       spu_id,
...
create
external table dwd_fact_coupon_use(
    `id` string COMMENT '编号',
...
create
external table dwd_fact_order_info (
    `id` string COMMENT '订单编号',
...
create
external table dwd_dim_user_info_his(
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_dim_user_info_his
select id,
       name,
       birthday,
       gender,
...
create
external table dwd_dim_user_info_his_tmp(
    `id` string COMMENT '用户id',
    `name` string COMMENT '姓名',
    `birthday` string COMMENT '生日',
    `gender` string COMMENT '性别',
...
hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
insert
overwrite table dwd_dim_user_info_his_tmp
select *
from (
         select id,
                name,
